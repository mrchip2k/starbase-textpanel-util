...
function About(props) {
	return (
		<Container addClass="page-content">
			...
			<p>Starbase disabled many special characters. All the characters shown in this website are confirmed to work in Starbase.</p>
			<p>It's not entirely clear to me if its license allows the font to be used in a website like this - if you are the author and have an issue with this, please contact me!</p>
